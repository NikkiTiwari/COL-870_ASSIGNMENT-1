...
Original file is located at
    https://colab.research.google.com/drive/1bwrrqRZ3zKbuTgCFlbIUES8z-wXg7wg4
"""
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc6 = nn.Linear(in_features=128, out_features=5) 
...
torch.save(net.state_dict(), './models/modelfc5.pth')

print(len(train_accuracies))
print(len(val_accuracies))
with open(r'trainfc5.txt', 'w') as fp:
  for item in train_accuracies:
     fp.write("%s\n" % item)
with open(r'valfc5.txt', 'w') as fp:
  for item in train_accuracies:
     fp.write("%s\n" % item)
