# -*- coding: utf-8 -*-
"""alternatepooling.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1J0NLiPTlHCdH7oSX7EoPGdWhWQda6gsV
"""
...
torch.save(net.state_dict(), './models/modelalternatemaxpooling.pth')
print(len(train_accuracies))
print(len(val_accuracies))
with open(r'trainalternatepooling.txt', 'w') as fp:
  for item in train_accuracies:
     fp.write("%s\n" % item)
with open(r'valalternatepooling.txt', 'w') as fp:
